...
This is the VB.NET version. We also have a [C# version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CitrixScanningDemo_CS_x86) available.  


## See Also
[HOWTO: Scan through Citrix or RDP (Terminal Server)](https://www.atalasoft.(mailto:sales@atalasoft.com)/kb2/KB/50227/HOWTO-Scan-through-Citrix-or-RDP-Terminal-Server)
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CitrixScanningDemo_VB_x86.git CitrixScanningDemo
```
